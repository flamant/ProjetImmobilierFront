...
export class ListProduitImmobilierComponent implements OnInit, AfterViewInit {
  ...
  openDialog(prestation: string) {
    ...
    dialogRef.afterClosed().subscribe( data => {this.search = data; self.loadSearch(); });
  }
